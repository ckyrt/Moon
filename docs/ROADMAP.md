...
> **从引擎到平台的完整路径**  
> 查看 [VISION.md](VISION.md) 了解我们要解决的核心问题和商业模式
...
- ⏳ **8. Gizmo 操作** - 位移/旋转/缩放工具
- ⏳ **9. 拾取系统** - 射线投射，鼠标选择
- ⏳ **10. WebUI 编辑器** - React + CEF 集成
- ⏳ **11. 场景树面板** - Hierarchy 视图
- ⏳ **12. 属性面板** - Inspector 视图
...
- ⏳ **13. CSG 基础图元** - 立方体、球体、圆柱等
- ⏳ **14. CSG 布尔运算** - 并集、交集、差集
- ⏳ **15. CSG 编辑工具** - 拉伸、扫掠、倒角
- ⏳ **16. 网格生成与优化** - 高质量网格输出

**完成标志**: 用户可以在编辑器中创建建筑和场景，无需 Blender
